export const constants = {
  PLUGIN_NAME: 'homebridge-my-tadiran',
  PLATFORM_NAME: 'MyTadiran',
...
export const { PLUGIN_NAME, PLATFORM_NAME, COGNITO_URL, COGNITO_CLIENT_ID, TADIRAN_BASE_URL, ORG_ID_IL, ORG_ID_EU, TEMP_MIN, TEMP_MAX, DEFAULT_POLL_INTERVAL } = constants;
