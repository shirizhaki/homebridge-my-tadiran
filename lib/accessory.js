...
const { TEMP_MIN, TEMP_MAX } = require('./constants');
...
class TadiranAccessory {
  ...
  updateFromCloud(device) {
    ...
    for (const [key, pending] of [...this.pending.entries()]) {
      ...
      } else if (pending.disagreements >= PENDING_MAX_DISAGREEMENTS) {
        this.pending.delete(key);
      } else {
...
module.exports = { TadiranAccessory, normalizeTemp };
